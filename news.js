...
async function getDataNewsCovid(){
    ...
    await(async function(){
        fetch('https://cropobs-central.alliance.cgiar.org/api/v1/covid-seccion/noticias').then(function(response){
...
function cardsAppendData(data){
    ...
    for (let idx = 0; idx < data.length; idx++) {
        ...
        photo.onerror = () => {
            photo.src = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQUPgYP6PrURjLZQ-ZQlssZISiAmqaCR9IHPmOSY-c6Sd77-QF-ZD-5owM2bOke42NrP6c&usqp=CAU";
        }
        meta.className = 'meta';
